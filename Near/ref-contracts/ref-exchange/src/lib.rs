...
mod tests {
    ...
    fn create_pool_with_liquidity(
        ...
        testing_env!(context
            ...
            .build());
        let pool_id = contract.add_simple_pool(tokens);
        testing_env!(context
            .predecessor_account_id(account_id.clone())
    ...
    fn test_liquidity() {
        ...
        testing_env!(context
            ...
            .attached_deposit(to_yocto("1"))
            .build());
        let id = contract.add_simple_pool(vec![accounts(1), accounts(2)]);
    ...
    fn test_stable() {
        ...
        testing_env!(context
            ...
            .build());
        let pool_id = contract.add_stable_swap_pool(tokens, vec![18, 18], 240);
        println!("{:?}", contract.version());
        println!("{:?}", contract.get_stable_pool(pool_id));
        println!("{:?}", contract.get_pools(0, 100));
        println!("{:?}", contract.get_pool(0));
        assert_eq!(1, contract.get_number_of_pools());
        assert_eq!(20, contract.get_pool_fee(pool_id));
        testing_env!(context
            .predecessor_account_id(accounts(3))
            .attached_deposit(to_yocto("0.03"))
            .build());
